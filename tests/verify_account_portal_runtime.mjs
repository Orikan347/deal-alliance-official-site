...
console.log('PASS_ACCOUNT_PORTAL_RUNTIME disabled=hidden incomplete=hidden invalid_origin=hidden http=hidden approved_https=two_links fake_urls_only=true');
